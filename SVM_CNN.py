...
main = tkinter.Tk()
main.title("Detection of Crops and Weeds using 3D Convolutional neural network(3D CNN)")
...
def predictCancer():
    ...
    msg = ''
    if predict == 0:
        msg = "Uploaded image is crop"
    if predict == 1:
        msg = "Uploaded image is weed"
    img = cv2.imread(filename)
...
font = ('times', 14, 'bold')
title = Label(main, text='Detection of Crops or Weeds using 3D Convolutional neural network(3D CNN)')
